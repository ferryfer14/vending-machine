...
class _$SlotModelCopyWithImpl<$Res, $Val extends SlotModel>
  ...
  $VendingModelCopyWith<$Res>? get vending {
    ...
    return $VendingModelCopyWith<$Res>(_value.vending!, (value) {
...
class _$_SlotModel extends _SlotModel {
  ...
  @override
  String toString() {
    return 'SlotModel(id: $id, name: $name, product: $product, vending: $vending, price: $price, stock: $stock, statusDrop: $statusDrop, amount: $amount)';
  }
